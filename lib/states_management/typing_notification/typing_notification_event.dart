...
abstract class TypingNotificationEvent extends Equatable {
  ...
  factory TypingNotificationEvent.onTypingEventSent(TypingEvent event) => TypingNotificationSent(event);
...
class Subscribed extends TypingNotificationEvent {
  ...
  const Subscribed(this.user, {List<String>? usersWithChat})
      : this.usersWithChat = usersWithChat == null ? const [] : usersWithChat;
